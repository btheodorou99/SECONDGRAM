...
realTestData = pickle.load(open('/data/theodoroubp/imageGen/data/testData.pkl', 'rb'))
...
for run in tqdm(range(NUM_RUNS), desc=f'{key} Runs'):
    ...
    generatedTestData = pickle.load(open(f'/data/theodoroubp/imageGen/generations/generatedTestData_{key}_{run}.pkl', 'rb'))
    ...
    pickle.dump(stats, open(f'/data/theodoroubp/imageGen/stats/modelingStats_{key}_{run}.pkl', 'wb'))